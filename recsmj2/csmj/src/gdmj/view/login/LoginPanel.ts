...
class LoginPanel extends BasePanel{
    ...
    private addFocusListener() {
        this.nameEdit.addEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.nameEdit.addEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);

        this.passEdit.addEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.passEdit.addEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);

        this.phoneEdit.addEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.phoneEdit.addEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);

        this.verifyEdit.addEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.verifyEdit.addEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);

        this.passEditZS.addEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.passEditZS.addEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);

        this.passEditZU.addEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.passEditZU.addEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);

        this.phoneEdit0.addEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.phoneEdit0.addEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);

        this.verifyEdit0.addEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.verifyEdit0.addEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);

        this.passEditZS0.addEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.passEditZS0.addEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);

        this.passEditZU0.addEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.passEditZU0.addEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);

        this.nameEdit0.addEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.nameEdit0.addEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);
    }

    private removeFocusListener() {
        this.nameEdit.removeEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.nameEdit.removeEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);

        this.passEdit.removeEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.passEdit.removeEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);

        this.phoneEdit.removeEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.phoneEdit.removeEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);

        this.verifyEdit.removeEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.verifyEdit.removeEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);

        this.passEditZS.removeEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.passEditZS.removeEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);

        this.passEditZU.removeEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.passEditZU.removeEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);

        this.phoneEdit0.removeEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.phoneEdit0.removeEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);

        this.verifyEdit0.removeEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.verifyEdit0.removeEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);

        this.passEditZS0.removeEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.passEditZS0.removeEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);

        this.passEditZU0.removeEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.passEditZU0.removeEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);
        
        this.nameEdit0.removeEventListener(egret.FocusEvent.FOCUS_IN, this.FcousIn, this);
        this.nameEdit0.removeEventListener(egret.FocusEvent.FOCUS_OUT, this.FcousOut, this);
    }

    private FcousIn() {
        App.NativeBridge.senFocusStatue({status: "openKeyboard"})
    }

    private FcousOut() {
        App.NativeBridge.senFocusStatue({status: "closeKeyboard"})
    }
    ...
    */
    ...
    private onTouchSubmit() {
        ...
        if (phoneText) {
            ...
            dataGame.param.sex = (Number(this.sexMRadio.group.selectedValue)+1)+"";
            dataGame.param.headimgindex = (Number(this.iconRadio.group.selectedValue)+1)+"";
            dataGame.uid = App.DataCenter.UserInfo.getMyUserVo().userID;
            http.send(dataGame, (data)=>{
                console.log("基本信息返回"+JSON.stringify(data));
                if (!data.ret) {

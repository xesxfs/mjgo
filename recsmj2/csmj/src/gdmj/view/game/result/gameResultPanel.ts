...
class GameResultPanel extends BasePanel {
    ...
    private onChangeDesk() {
        var gameCtrl: ReGameController = App.getController(ReGameController.NAME);
        gameCtrl.sendChangeDesk();
        var gamescene:ReGameScene = App.SceneManager.getScene(SceneConst.ReGameScene);
        var gameCtrl: ReGameController = App.getController(ReGameController.NAME);
        gamescene.headPlugin.resetHeadUI();
        gamescene.discPlugin.hideDisc();
    ...
    private onContinue() {
        if (App.DataCenter.roomInfo.roomType == RoomType.MatchRoom) {
            var game :ReGameScene = App.SceneManager.getScene(SceneConst.ReGameScene);
            game.readyPlugin.readyBtn.visible = true;
            game.resetGame();
            game.headPlugin.resetHeadUI();
            game.discPlugin.hideDisc();
            this.hide();
            var gameCtrl: ReGameController = App.getController(ReGameController.NAME);
            gameCtrl.sendReady();
        } else {
    ...
    private xujuTouch() {
        var gamescene :ReGameScene = App.SceneManager.getScene(SceneConst.ReGameScene);
        gamescene.resetGame();
        gamescene.btnGroupPlugin.hideBtnGroup();
        gamescene.readyPlugin.readyBtn.visible = true;
        gamescene.headPlugin.resetHeadUI();
        gamescene.discPlugin.hideDisc();
        gamescene.roomTypePlugin.showFriendRoom();
        this.hide();
    }

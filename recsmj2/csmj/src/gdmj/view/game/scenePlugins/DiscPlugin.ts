...
class DiscPlugin extends BaseUI {
    ...
    /**显示圆盘上的风位(东南西北)*/
    public showDiceFengWei(pos: UserPosition) {
        this.hideAllFengWei();

...
class App extends BaseApp{
    ...
    /**独立包标识 */
    public indepFlag: boolean;
    /**游客标识 */
    public visitorFlag: boolean;
    ...
    public startUp(): void {
        ...
        this.registerController(ReGameController.NAME,new ReGameController());
        ...
        scene.register(SceneConst.ReGameScene,ReGameScene)     //重构游戏界面

...
class NewLevelExpComponent extends eui.Component{
...
protected childrenCreated(){
	...
	CommonFuc.AddClickEvent(this,egret.TouchEvent.TOUCH_TAP,this.frontBgClick,this);
}

private frontBgClick(){
	 if (Number(GlobalClass.LoginClass.SmallRecharge)<=0 ){
        console.log("GlobalClass.LoginClass.SmallRecharge="+GlobalClass.LoginClass.SmallRecharge);  
        return
	 }
	KFControllerMgr.getCtl(PanelName.PersonalPanel).show();
}

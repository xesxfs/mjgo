 ...
 * 基础修改 见如下//***  位置
 */
var Examples_addBasicBody3 = (function (_super) {
    __extends(Examples_addBasicBody3, _super);
    function Examples_addBasicBody3() {
    ...
    Examples_addBasicBody3.prototype.onAdded2stage = function (e) {
        this.createGameScene();
    };
    /**
    * 创建游戏场景
    */
    Examples_addBasicBody3.prototype.createGameScene = function () {
        //创建world
     ...
     * p2 physics run step
     */
    Examples_addBasicBody3.prototype.p2RunStep = function (dt) {
        if (dt < 10) {
            return;
        }
        if (dt > 1000) {
        ...
        for (var i = 0; i < l; i++) {
            ...
            if (boxBody.displays && boxBody.displays[0]) {
                ...
                //************************************************************************************
                box.y = -boxBody.position[1] * this.factor; //把物理世界的位置转换到显示世界的位置，取反
                box.rotation = -boxBody.angle * 180 / Math.PI; //把物理世界刚体角度转换为显示世界角度，取反
                //************************************************************************************
     ...
     * 点击鼠标，添加一个刚体
     */
    Examples_addBasicBody3.prototype.addOneBox = function (e) {
        //在物理世界中的位置
    ...
    */
    Examples_addBasicBody3.prototype.createBitmapByName = function (name) {
    ...
    * 创建一个圆形
    */
    Examples_addBasicBody3.prototype.createBall = function (r) {
    ...
    * 创建一个方形
    */
    Examples_addBasicBody3.prototype.createBox = function (width, height) {
        var shape = new egret.Shape();
        shape.graphics.beginFill(0xfff000);
    ...
    return Examples_addBasicBody3;
}(egret.Sprite));
__reflect(Examples_addBasicBody3.prototype, "Examples_addBasicBody3");
//# sourceMappingURL=Examples_addBasicBody3.js.map
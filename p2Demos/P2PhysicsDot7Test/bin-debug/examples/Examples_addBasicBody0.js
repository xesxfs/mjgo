 ...
 *
 */
var Examples_addBasicBody0 = (function (_super) {
    __extends(Examples_addBasicBody0, _super);
    function Examples_addBasicBody0() {
    ...
    Examples_addBasicBody0.prototype.onAdded2stage = function (e) {
        this.createGameScene();
    };
    /**
    * 创建游戏场景
    */
    Examples_addBasicBody0.prototype.createGameScene = function () {
        //创建world
     ...
     * p2 physics run step
     */
    Examples_addBasicBody0.prototype.p2RunStep = function (dt) {
        if (dt < 10) {
            return;
        }
        if (dt > 1000) {
     ...
     * 点击鼠标，添加一个刚体
     */
    Examples_addBasicBody0.prototype.addOneBox = function (e) {
        //在物理世界中的位置
        var positionX = Math.floor(e.stageX / this.factor); //显示位置变换到物理世界位置
        var positionY = 6; //直接给一个p2的坐标
        var display;
        var tarBody;
        if (Math.random() > 0.5) {
            //添加方形刚体
    ...
    */
    Examples_addBasicBody0.prototype.createBitmapByName = function (name) {
    ...
    * 创建一个圆形
    */
    Examples_addBasicBody0.prototype.createBall = function (r) {
    ...
    * 创建一个方形
    */
    Examples_addBasicBody0.prototype.createBox = function (width, height) {
        var shape = new egret.Shape();
        shape.graphics.beginFill(0xfff000);
    ...
    return Examples_addBasicBody0;
}(egret.Sprite));
__reflect(Examples_addBasicBody0.prototype, "Examples_addBasicBody0");
//# sourceMappingURL=Examples_addBasicBody0.js.map
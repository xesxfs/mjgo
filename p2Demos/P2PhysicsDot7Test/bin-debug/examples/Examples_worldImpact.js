 ...
 */
var Examples_worldImpact = (function (_super) {
    __extends(Examples_worldImpact, _super);
    function Examples_worldImpact() {
        var _this = _super.call(this) || this;
        _this.playerBodyId = 4;
        Examples_worldImpact.inst = _this;
        _this.addEventListener(egret.Event.ADDED_TO_STAGE, _this.onAdded2stage, _this);
        return _this;
    }
    Examples_worldImpact.prototype.onAdded2stage = function (e) {
    ...
    Examples_worldImpact.prototype.onWorldImpact = function (event) {
    ...
    Examples_worldImpact.prototype.onBeginContactCheck = function (event) {
        var bodyA = event.bodyA;
        var bodyB = event.bodyB;
    ...
    //获得player碰撞位置
    Examples_worldImpact.prototype.getPlayerContactPos = function () {
    ...
    return Examples_worldImpact;
}(egret.Sprite));
__reflect(Examples_worldImpact.prototype, "Examples_worldImpact");
//# sourceMappingURL=Examples_worldImpact.js.map
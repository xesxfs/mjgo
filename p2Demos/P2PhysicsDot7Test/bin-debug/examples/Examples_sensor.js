 ...
 */
var Examples_sensor = (function (_super) {
    __extends(Examples_sensor, _super);
    function Examples_sensor() {
        var _this = _super.call(this) || this;
        _this.playerBodyId = 4;
        Examples_sensor.inst = _this;
        _this.addEventListener(egret.Event.ADDED_TO_STAGE, _this.onAdded2stage, _this);
        return _this;
    }
    Examples_sensor.prototype.onAdded2stage = function (e) {
        ...
        this.name = "Examples_sensor";
    };
    Examples_sensor.prototype.onBeginContact = function (event) {
        Examples_sensor.inst.onBeginContactCheck(event);
    };
    Examples_sensor.prototype.onEndContact = function (event) {
    ...
    Examples_sensor.prototype.onBeginContactCheck = function (event) {
        var bodyA = event.bodyA;
        var bodyB = event.bodyB;
    ...
    //获得player碰撞位置
    Examples_sensor.prototype.getPlayerContactPos = function () {
    ...
    return Examples_sensor;
}(egret.Sprite));
__reflect(Examples_sensor.prototype, "Examples_sensor");
//# sourceMappingURL=Examples_sensor.js.map
...
* 摩托车
* 后减震是真实软尾型
* 在Examples_dirtBike基础上，增加键盘控制
* @author
*/
var Examples_dirtBikeKeyCtrl = (function (_super) {
    __extends(Examples_dirtBikeKeyCtrl, _super);
    function Examples_dirtBikeKeyCtrl() {
    ...
    Examples_dirtBikeKeyCtrl.prototype.onAdded2stage = function (e) {
    ...
    Examples_dirtBikeKeyCtrl.prototype.createVehicle = function () {
    ...
    */
    Examples_dirtBikeKeyCtrl.prototype.setupFrontWheel = function (body1, wheelOffset, suspensionStartOffset) {
        //p2减震起始点,减震和车体结合点
    ...
    Examples_dirtBikeKeyCtrl.prototype.setupBackWheel2 = function (body1, wheelOffset) {
        var wheel;
        var p2PvtPointX;
        var p2PvtPointY;
        var pvtJtF;
    ...
    Examples_dirtBikeKeyCtrl.prototype.setupUI = function () {
    ...
    Examples_dirtBikeKeyCtrl.prototype.onBtnHorTouchBegin = function (e) {
        this.updateDirHorizontalValue(e.stageX, e.stageY);
    };
    Examples_dirtBikeKeyCtrl.prototype.onBtnHorTouchMove = function (e) {
        this.updateDirHorizontalValue(e.stageX, e.stageY);
    };
    Examples_dirtBikeKeyCtrl.prototype.onBtnHorTouchEnd = function (e) {
        this.dirHorizontal = 0;
    };
    Examples_dirtBikeKeyCtrl.prototype.updateDirHorizontalValue = function (stageX, stageY) {
    ...
    Examples_dirtBikeKeyCtrl.prototype.onBtnVerTouchBegin = function (e) {
        this.updateDirVerzontalValue(e.stageX, e.stageY);
    };
    Examples_dirtBikeKeyCtrl.prototype.onBtnVerTouchMove = function (e) {
        this.updateDirVerzontalValue(e.stageY, e.stageY);
    };
    Examples_dirtBikeKeyCtrl.prototype.onBtnVerTouchEnd = function (e) {
        this.dirVertical = 0;
    };
    Examples_dirtBikeKeyCtrl.prototype.updateDirVerzontalValue = function (stageX, stageY) {
    ...
    Examples_dirtBikeKeyCtrl.prototype.updateChassisAnglarForce = function () {
    ...
    Examples_dirtBikeKeyCtrl.prototype.updateKeyCtrl = function () {
        if (this.chassis == null) {
            return;
        }
        var chassisAnglarForce = this.chassisAnglarForceDefault;
    ...
    return Examples_dirtBikeKeyCtrl;
}(egret.Sprite));
__reflect(Examples_dirtBikeKeyCtrl.prototype, "Examples_dirtBikeKeyCtrl");
//# sourceMappingURL=Examples_dirtBikeKeyCtrl.js.map
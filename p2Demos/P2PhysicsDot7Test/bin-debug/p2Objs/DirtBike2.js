...
/**
 * 在DirtBike基础上改进，
 * 使用绝对位置点，有利于从可视化设计的数据创建车辆
 * @author
 *
 */
var DirtBike2 = (function (_super) {
    __extends(DirtBike2, _super);
    function DirtBike2() {
    ...
    DirtBike2.prototype.createVehicle = function (pscene) {
        this.scene = pscene;
    ...
    */
    DirtBike2.prototype.setupFrontWheel = function (chassis, wheelPos, suspensionStartPos) {
        //p2减震起始点,减震和车体结合点
        ...
        //在车体中绘制减震槽
        var chassisShape = chassis.displays[0];
    ...
    DirtBike2.prototype.setupBackWheel = function (chassis) {
        var wheel;
        var p2PvtPointX;
        var p2PvtPointY;
        var pvtJtF;
    ...
    * 更新车体和轮子的角力
    */
    DirtBike2.prototype.updateSteering = function (dirVertical, dirHorizontal) {
     ...
     * 跳跃
     */
    DirtBike2.prototype.jump = function () {
        if (jbP2.P2Space.checkIfCanJump(this.scene.world, this.wheelb)) {
            this.chassis.applyForce([0, 100], this.chassis.position);
            console.log("DirtBike2.jump");
        }
    };
    return DirtBike2;
}(egret.Sprite));
__reflect(DirtBike2.prototype, "DirtBike2");
//# sourceMappingURL=DirtBike2.js.map
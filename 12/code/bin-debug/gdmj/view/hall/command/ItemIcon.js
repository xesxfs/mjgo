...
(function (ItemIcon) {
    ...
    function getIcon4Name(name) {
        var icons = nameCode[name];
        if (!icons) {
            icons = "";
        }
        ;
    ...
    ItemIcon.getIcon4Name = getIcon4Name;
    /**
     * 获取商城中物品对应的图标资源名
     * @type 商品类型
     ...
     * @return 返回对应的图标资源名
    */
    function getShopIcon(type, index) {
    ...
    ItemIcon.getShopIcon = getShopIcon;
    /**抽奖图片*/
    var lotteryIconList = {
    ...
    ItemIcon.getLotteryIcon = getLotteryIcon;
})(ItemIcon || (ItemIcon = {}));

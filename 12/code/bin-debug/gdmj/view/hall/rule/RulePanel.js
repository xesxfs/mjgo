...
var RulePanel = (function (_super) {
    ...
    RulePanel.prototype.showWhatRule = function (index) {
        if (index) {
     ...
     * 显示规则文本
     */
    RulePanel.prototype.addFileDoc = function () {
     ...
     * 鸡平胡下面Stack
     */
    RulePanel.prototype.jpChildChangeViewStack = function (event) {
        var jpGroup = event.target;
    ...
    * 推倒胡stack
    */
    RulePanel.prototype.tdChileChangeViewStack = function (e) {
        var tdGroup = e.target;
        this.td_view_stack.selectedIndex = tdGroup.selectedValue;
        console.log("tdGroup=" + e.target);
    };
    RulePanel.prototype.setTxt = function (txt) {
     ...
     * 格式化内容文本
     */
    RulePanel.prototype.setContenText = function () {
        //"fontFamily":"楷体"
    ...
    /**设置鸡平胡基本番型*/
    RulePanel.prototype.setJiHuFanType = function () {
        if (this.jpFanTypeGroup.numChildren > 1) {
            return;
        }
        //0番 鸡胡
        var itemGroup = this.jpFanTypeGroup;
        var item = new FanTypeItem();
        item.setName("鸡胡：");
    ...
    /**设置推倒胡基本番型*/
    RulePanel.prototype.setTdFanType = function () {
        if (this.tdFanTypeGroup.numChildren > 1) {
            return;
        }
        //1番 小胡
        var itemGroup = this.tdFanTypeGroup;
        var item = new FanTypeItem();
        item.setName("小胡：");

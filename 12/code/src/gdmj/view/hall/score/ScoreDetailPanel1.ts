...
class ScoreDetailPanel1 extends BasePanel {
    public constructor() {
        super();
        this.skinName = "ScoreDetailPanelSkin1";
    }

    private selfImg: eui.Image;
    private user1Img: eui.Image;
    private user2Img: eui.Image;
    private user3Img: eui.Image;
